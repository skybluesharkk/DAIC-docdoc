...
- LangChain 프레임워크를 활용하여 고도화된 RAG(Retrieval-Augmented Generation) 시스템을 구현했으며 Reranker 모델을 도입하여 검색 정확도를 향상시켰습니다. 또한 FastAPI를 통한 WebSocket 서버를 구축하여 의료진의 질문에 대해 실시간으로 관련 논문을 검색하고, 정제된 컨텍스트를 Solar LLM에 전달하여 더욱 정확하고 근거 있는 답변을 생성합니다.
### 논문 수집 및 처리
