...
- LangChain 프레임워크를 활용하여 RAG(Retrieval-Augmented Generation) 시스템을 구현했으며, Reranker 모델을 도입하여 검색 정확도를 향상시켰습니다.
...
### 데이터 관리 및 보안
환자의 민감한 의료 정보와 논문 요약데이터를 분리하여 mysql 데이터베이스에서 관리하며, RAG 시스템을 위한 논문 임베딩 데이터는 Pinecone 벡터 DB에 저장합니다.
